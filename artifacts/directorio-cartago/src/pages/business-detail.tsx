    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-32 text-center">
          ...
          <Button asChild>
            <Link href="/businesses">Volver al directorio</Link>
          </Button>
        </div>
      </Layout>
    );
            ...
            {canViewPremiumInfo ? (
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 border border-amber-200 shadow-sm text-center relative overflow-hidden">
                ...
                <Button
                  asChild
                  size="lg"
                  className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl shadow-lg shadow-amber-500/30"
                >
                ...
                <div className="w-full h-full bg-muted/50 rounded-2xl flex flex-col items-center justify-center p-6 text-center">
                  ...
                  {!canViewPremiumInfo && (
                    <p className="text-xs text-muted-foreground mt-4">
                      Mapa interactivo disponible en{" "}
