      ...
      <Layout>
        <div className="container py-20 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Debes ser dueño de negocio para acceder a esta sección.
          </p>
        </div>
      </Layout>
    );
        ...
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Gestiona tus publicaciones en el directorio.
            </p>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-card rounded-3xl border border-border border-dashed">
            ...
            <p className="text-muted-foreground mb-6">
              Comienza agregando tu primer negocio al directorio.
            </p>
          ...
          <div className="grid grid-cols-1 gap-6">
            {myBusinesses.map((biz) => (
              <div
                key={biz.id}
                className="bg-card rounded-2xl border border-border p-6 flex flex-col sm:flex-row gap-6 items-center shadow-sm"
              >
                <img
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent className="rounded-3xl">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Esta acción no se puede deshacer. Se borrarán todos
                            los datos de {biz.name}.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
