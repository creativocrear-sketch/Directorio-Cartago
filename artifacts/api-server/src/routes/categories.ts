...
router.post("/categories", requireAdmin, async (req: AuthRequest, res): Promise<void> => {
...
router.put("/categories/:id", requireAdmin, async (req: AuthRequest, res): Promise<void> => {
...
router.delete("/categories/:id", requireAdmin, async (req: AuthRequest, res): Promise<void> => {
